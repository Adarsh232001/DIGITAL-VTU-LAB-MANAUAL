import sys,os,pyperclip,webbrowser
...
data = {
    ...
    'DBMS LABORATORY WITH MINI PROJECT(18CSL58)' : ["1.Library Database","2.Order Database","3.Movie Database","4.College Database",
                                "5.Company Database","DBMS MINI PROJECT"]
}
program_data = {
...
program_path = {
    'C PROGRAMMING LABORATORY(18CPL17/27)' : 'python\Python GUI project\LAB MAUAL\data\c\source',
    'DATA STRUCTURES LABORATORY(18CSL38)' : 'python\Python GUI project\LAB MAUAL\data\ds\source',
    'DESIGN AND ANALYSIS OF ALGORITHM LABORATORY(18CSL47)' : 'python\Python GUI project\LAB MAUAL\data\daa\source',
    'COMPUTER NETWORK LABORATORY(18CSL57)' : 'python\Python GUI project\LAB MAUAL\data\cns\source',
    'DBMS LABORATORY WITH MINI PROJECT(18CSL58)' : 'python\Python GUI project\LAB MAUAL\data\dbms\source'
}
image_path = {
    'C PROGRAMMING LABORATORY(18CPL17/27)' : 'python\Python GUI project\LAB MAUAL\data\c\output',
    'DATA STRUCTURES LABORATORY(18CSL38)' : 'python\Python GUI project\LAB MAUAL\data\ds\output',
    'DESIGN AND ANALYSIS OF ALGORITHM LABORATORY(18CSL47)' : 'python\Python GUI project\LAB MAUAL\data\daa\output',
    'COMPUTER NETWORK LABORATORY(18CSL57)' : 'python\Python GUI project\LAB MAUAL\data\cns\output',
    'DBMS LABORATORY WITH MINI PROJECT(18CSL58)' : 'python\Python GUI project\LAB MAUAL\data\dbms\output'
}
image_data = {
...
"background-color: rgb(170, 255, 255);")
        ...
        self.comboCourse.setGeometry(QtCore.QRect(240, 180, 411, 31))
...
class Ui_Dialog_1(object):
    ...
    def retranslateUi(self, Dialog):
        _translate = QtCore.QCoreApplication.translate
        Dialog.setWindowTitle(_translate("Dialog", "SCREEN SHOT"))
...
class Ui_Dialog_2(object):
    ...
    def retranslateUi(self, Dialog_2):
        _translate = QtCore.QCoreApplication.translate
        Dialog_2.setWindowTitle(_translate("Dialog_2", "OUTPUT TEXT"))
